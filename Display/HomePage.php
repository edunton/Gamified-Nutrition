...
EOD;
        ...
        $lst = function () use (&$history) {
            ...
            if ($offset !== 0) {
                ...
                echo '<div class="alert alert-info text-center" role="alert">No history so far!</div>';
            }
        };
  ...
  <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width:' . $p . '%">' . $p .'%
                ...
                echo '<div class="alert alert-info text-center" role="alert">No achievement so far!</div>';
            }
        };
